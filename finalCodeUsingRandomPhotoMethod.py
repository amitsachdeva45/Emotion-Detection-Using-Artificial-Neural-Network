...
def testingSet():
    ...
    while i<50:
        ...
        if chc==1:
            ...
            if i%3==0:
                rrr=(i/3)+1
                kkk="W:\\MAJORPROJECt\\Python\\MajorProje\\funny\\f"+str(rrr)+".jpg"
            print "RRR"
            print rrr
            img21 = cv2.imread("W:\\MAJORPROJECt\\Python\\MajorProje\\funny\\f"+str(rrr)+".jpg")
            #print img21
            ...
            if i%3==0:
                rrr=(i/3)+1
                kkk="W:\\MAJORPROJECt\\Python\\MajorProje\\sad\\p"+str(rrr)+".jpg"
            print "RRR"
            print rrr
            img21 = cv2.imread("W:\\MAJORPROJECt\\Python\\MajorProje\\sad\\p"+str(rrr)+".jpg")
            #print img21
            cv2.namedWindow('IMAGE', cv2.WINDOW_NORMAL)
            cv2.imshow('IMAGE',img21)
...
if __name__ == '__main__':
    ...
    file.write("\n"+"Type Choosen"+(str)(chcc)+" Smiling="+(str)(jj)+" "+"SHOCKED="+(str)(kk)+"SAD=1.0 "+"ANGRY=0.5 "+"DISGUIST=2.0 "+"Neutral=9.0 "+ "Folder"+(str)(folder1))
    file.close()
    tkMessageBox.showinfo( "ASPERGER SYANDROME", "Smiling"+(str)(jj)+" "+"SHOCKED"+(str)(kk)+"SAD=1.0 "+"ANGRY=0.5 "+"DISGUIST=2.0 "+"Neutral=9.0")
    print "Type Choosen"+(str)(chcc)+"Smiling="+(str)(jj)+" "+"SHOCKED="+(str)(kk)+"Folder"+"SAD=1.0 "+"ANGRY=0.5 "+"DISGUIST=2.0 "+"Neutral=9.0 "+(str)(folder1)
    time.sleep(10)
